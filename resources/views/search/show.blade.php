        ...
        <div class="fondo--single--blog">
            <div class="filtro--single--blog">
                <div class="titulo--blog--post text-center">
                    <h1 class="display-3  text-white">Resultados</h1>
                    
                    <h3 class="text-white ">Se encontraron {{ $posts->count() }} resultados para el término {{ $query }}</h3>
                </div>
            </div>
    ...
    <div class="container">
        <div class="contenedor--single--post col-md-12">
            <div class="titular--single--post col-md-9">
                ...
                <!-- {{ Form::open(['route' => 'search', 'method' => 'get', 'id' => 'bloque-buscar']) }} -->
                    <form action="{{ url('/search') }}" id="bloque-buscar" method="get">
                        <div class="contenedor-bloque-buscar">
                        <!-- {{ Form::text('search', null, ['placeholder'=> 'Buscar...']) }}  -->
                        <input class="" placeholder="Buscar un articulo.." type="text" name="query" id="">
...
<div class=" col-md-12 d-flex align-content-center justify-content-center"> {{ $posts->render() }}
</div>
